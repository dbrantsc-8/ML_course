...
def basic_cnn():
    ...
    model = torch.nn.Sequential(
        ...
        torch.nn.ReLU(),
        torch.nn.Conv2d(in_channels = 64, out_channels = 128, kernel_size = 5, padding = 2, stride = 2),
        torch.nn.ReLU(),
        torch.nn.Conv2d(in_channels = 128, out_channels = 64, kernel_size = 5, padding = 2),
        torch.nn.ReLU(),
        torch.nn.AdaptiveAvgPool2d(1),
        torch.nn.Conv2d(in_channels = 64, out_channels = 2, kernel_size = 1),
        torch.nn.Flatten(),
    )
